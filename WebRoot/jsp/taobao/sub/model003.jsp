...
<form action="" method="post" class="definewidth m20" id="form_submit">
    ...
    <div id="right">
        ...
        <table class="table table-bordered table-hover definewidth m10">
            ...
            <tbody>
            <%-- 					<tr>
                                    <td align="right">背景图(950*655像素)建议不换</td>
                                    <c:choose>
                                        <c:when test="${bean.value01==''}">
                                            <td><input type="text" style="width: 100%;" value="//gdp.alicdn.com/imgextra/i3/200258047/TB2xPvzfpXXXXXMXpXXXXXXXXXX_!!200258047.png" name="bean.value01"></td>
                                        </c:when>

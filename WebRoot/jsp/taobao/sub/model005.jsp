...
<form action="" method="post" class="definewidth m20" id="form_submit">
    ...
    <div id="right">
        ...
        <table class="table table-bordered table-hover definewidth m10" style="text-align: center;">
            ...
            <tr>
                <td style="text-align: center;background-color: #ECECFF;" colspan="3">卧室商品图片</td>
            </tr>
            <tr>
                <td>卧室(两个字)</td>
            ...
            <tr>
                <td style="text-align: center;background-color: #ECECFF;" colspan="3">客厅商品图片</td>
            </tr>
            <tr>
                <td>客厅(两个字)</td>
            ...
            <tr>
                <td style="text-align: center;background-color: #ECECFF;" colspan="3">餐厅商品图片</td>
            </tr>
            <tr>
                <td>餐厅(两个字)</td>

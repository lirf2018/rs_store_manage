...
<form action="" method="post" class="definewidth m20" id="form_submit">
    ...
    <div id="right">
        ...
        <table class="table table-bordered table-hover definewidth m10">
            ...
            <tr>
                <td align="right">商品图片1(314*314像素)</td>
            ...
            <tr>
                <td align="right">商品图片2(314*314像素)</td>
            ...
            <tr>
                <td align="right">商品图片3(314*314像素)</td>
            ...
            <tr>
                <td align="right">商品图片4(314*314像素)</td>
            ...
            <tr>
                <td align="right">商品图片5(314*314像素)</td>
            ...
            <tr>
                <td align="right">商品图片6(314*314像素)</td>
            ...
            <tr>
                <td align="right">商品图片7(314*314像素)</td>
            ...
            <tr>
                <td align="right">商品图片8(314*314像素)</td>
            ...
            <tr>
                <td align="right">商品图片9(314*314像素)</td>
            ...
            <tr>
                <td align="right">商品图片10(314*314像素)</td>
            ...
            <tr>
                <td align="right">商品图片11(314*314像素)</td>
            ...
            <tr>
                <td align="right">商品图片12(314*314像素)</td>

    ...
    <div id="right">
        ...
        <table class="table table-bordered table-hover definewidth m10">
            ...
            <tr>
                ...
                <c:choose>
                    <c:when test="${bean.value01==''}">
                        <td><input type="text" style="width: 100%;" value="SUMMER NEW" name="bean.value01"></td>
                    </c:when>
                    <c:when test="${empty bean.value01}">
                        <td><input type="text" style="width: 100%;" value="SUMMER NEW" name="bean.value01"></td>
                    </c:when>
                    <c:otherwise>
            ...
            <tr>
                <td align="right">店长推荐</td>
                <c:choose>
                    <c:when test="${bean.value02==''}">
                        <td><input type="text" style="width: 100%;" value="店长推荐" name="bean.value02"></td>
                    </c:when>
                    <c:when test="${empty bean.value02}">
                        <td><input type="text" style="width: 100%;" value="店长推荐" name="bean.value02"></td>
                    </c:when>
                    <c:otherwise>
            ...
            <tr>
                <td align="right">商品图片1(230*230像素)</td>
                <td><input type="text" style="width: 100%;" value="${bean.value03}" name="bean.value03"></td>
                <td>value03</td>
            </tr>
            <tr>
                <td align="right">商品图片1商品链接地址</td>
                <td><input type="text" style="width: 100%;" value="${bean.value04}" name="bean.value04"></td>
                <td>value04</td>
            </tr>
            <tr>
                <td align="right">商品图片1价格</td>
                <td><input type="text" style="width: 100%;" value="${bean.value05}" name="bean.value05"></td>
                <td>value05</td>
            </tr>
            <tr>
                <td align="right">限时购买</td>
                <c:choose>
                    <c:when test="${bean.value06==''}">
                        <td><input type="text" style="width: 100%;" value="限时购买" name="bean.value06"></td>
                    </c:when>
                    <c:when test="${empty bean.value06}">
                        <td><input type="text" style="width: 100%;" value="限时购买" name="bean.value06"></td>
                    </c:when>
                    <c:otherwise>
            ...
            <tr>
                <td align="right">限时购买</td>
                <c:choose>
                    <c:when test="${bean.value10==''}">
                        <td><input type="text" style="width: 100%;" value="限时购买" name="bean.value10"></td>
                    </c:when>
                    <c:when test="${empty bean.value10}">
                        <td><input type="text" style="width: 100%;" value="限时购买" name="bean.value10"></td>
                    </c:when>
                    <c:otherwise>
            ...
            <tr>
                <td align="right">限时购买</td>
                <c:choose>
                    <c:when test="${bean.value14==''}">
                        <td><input type="text" style="width: 100%;" value="限时购买" name="bean.value14"></td>
                    </c:when>
                    <c:when test="${empty bean.value14}">
                        <td><input type="text" style="width: 100%;" value="限时购买" name="bean.value14"></td>
                    </c:when>
                    <c:otherwise>
            ...
            <tr>
                <td align="right">限时购买</td>
                <c:choose>
                    <c:when test="${bean.value18==''}">
                        <td><input type="text" style="width: 100%;" value="限时购买" name="bean.value18"></td>
                    </c:when>
                    <c:when test="${empty bean.value18}">
                        <td><input type="text" style="width: 100%;" value="限时购买" name="bean.value18"></td>
                    </c:when>
                    <c:otherwise>

...
<form class="form-inline definewidth m20" action="" method="get">
    卡券名称： <input id="ticketName" type="text" name="ticketName" class="abc input-default" placeholder="" value="">&nbsp;
    ...
    <button type="button" class="btn btn-success" id="addParentMenu" onclick="toAddOrUpdatePage()">新增卡券规则</button>
    &nbsp;
</form>
...
<script>
    ...
    function listdata(currentPage) {
        ...
        $.ajax({
            ...
            async: true,
            cache: false,
            url: "${path}/manage/loadTicletRulePage.action",
            dataType: "json",
    ...
    function toAddOrUpdatePage() {
        window.location.href = "${path}/manage/toAddTicketRuleRel.action";
    }

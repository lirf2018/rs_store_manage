...
<form class="form-inline definewidth m20" action="" method="get">
    ...
    商家名称： <input id="partnersName" type="text" name="partnersName" class="abc input-default" placeholder="" value="">&nbsp;
    ...
    <button type="button" class="btn btn-success" id="addParentMenu" onclick="toAddOrUpdatePage()">新增商家规则</button>
    &nbsp;
</form>
...
<script>
    ...
    function listdata(currentPage) {
        ...
        $.ajax({
            ...
            async: true,
            cache: false,
            url: "${path}/manage/loadPartnersRulePage.action",
            dataType: "json",
    ...
    function toAddOrUpdatePage() {
        window.location.href = "${path}/manage/toAddPartnersRuleRel.action";
    }

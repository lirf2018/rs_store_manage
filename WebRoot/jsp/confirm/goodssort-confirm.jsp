...
<form class="form-inline definewidth m20 " action="index.html" method="get">
    ...
    <button type="button" class="btn btn-success" onclick="paramConfirm()">商品排序确认</button> &nbsp;
</form>
<div id="right">
...
<script>
    ...
    function listdata(currentPage) {
        ...
        $.ajax({
            ...
            async: false,
            cache: false,
            url: "${path}/manage/loadGoodsList.action",
            dataType: "json",
            success: function (data) {
                ...
                for (var i = 0; i < resultListMap.length; i++) {
                    ...
                    strs = strs + "<td><input type='text' data-id='" + obj.goods_id + "' value='" + obj.weight + "' style='width: 45px;text-align: center' name='goodsSort'></td>";//排序
    ...
    function paramConfirm() {
        ...
        $.ajax({
            ...
            async: false,
            cache: false,
            url: "${path}/manage/goodssortConfirm.action",
            dataType: "json",
            success: function (data) {
                if (data.flag == "ok") {
                    alert(data.msg);

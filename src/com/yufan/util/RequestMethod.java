...
//			System.out.println(result);
     ...
     * };
     */
    public static String httpPostForm(String url, NameValuePair[] data) {
        ...
        try {
            ...
            System.out.println("http请求结果：" + SubmitResult);
            return SubmitResult;
     ...
     * @return
     */
    public static String httpPostNetease(List<org.apache.http.NameValuePair> nvps, String url, String appSecret, String appkey) {
        try {
            LOG.info("url=" + url);
        ...
        try {
            ...
            if (paramsMap != null) {
                ...
                for (Map.Entry<String, String> param : paramsMap.entrySet()) {
                    org.apache.http.NameValuePair pair = new BasicNameValuePair(param.getKey(),
                            param.getValue());
                    paramList.add(pair);
                }
